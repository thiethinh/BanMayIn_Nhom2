        ...
        <div class="login-container" id="login">
            ...
            <form action="login" method="post" class="two-forms">
                ...
                <div class="two-col">
                    ...
                    <div class="two">
                        <label><a href="${pageContext.request.contextPath}/forgot-password.jsp">Quên mật
                            khẩu?</a></label>
                    </div>
                </div>
        ...
        <div class="register-container" id="register">
            ...
            <form action="register" method="post" class="two-forms">
                ...
                <div class="two-col">
                    ...
                    <div class="two">
                        <label><a href="${pageContext.request.contextPath}/policies-and-services.jsp">Điều khoản & Dịch
                            vụ</a></label>
                    </div>
                </div>
        ...
        <div class="otp-box">
            ...
            <form action="verify-code" method="post">
                ...
                <div style="margin-top: 15px;">
                    <a href="login.jsp" style="text-decoration: none; color: #555;">Quay lại</a>
                </div>
            </form>
        </div>
    </div>
