                ...
                <form action="account" method="post" class="account-form">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="first-name" name="firstname" value="${sessionScope.acc.fname}" required>
                        </div>
                        <div class="form-group">
                            <label for="last-name">Tên</label>
                            <input type="text" id="last-name" name="lastname" value="${sessionScope.acc.lname}" required>
                        </div>
                    </div>
