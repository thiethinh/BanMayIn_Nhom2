...
<aside class="admin-sidebar">
    ...
    <nav class="admin-nav">
        <ul>
            <li>
                <a href="${pageContext.request.contextPath}/admin" class="${fn:endsWith(uri, '/admin.jsp') || fn:endsWith(uri, '/admin.jsp/') ? 'active' : ''}">
                    <i class="fa-solid fa-gauge"></i> Bảng Điều Khiển
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/admin-product" class="${fn:contains(uri, 'admin-product') ? 'active' : ''}">
                    <i class="fa-solid fa-box-archive"></i> Quản Lý Sản Phẩm
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/admin-review" class="${fn:contains(uri, 'admin-review') ? 'active' : ''}">
                    <i class="fa-solid fa-file-lines"></i> Quản Lý Đánh Giá
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/admin-order-manage" class="${fn:contains(uri, 'admin-order-manage') ? 'active' : ''}">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/admin-blog?view=pending" class="${fn:contains(uri, 'admin-blog') ? 'active' : ''}">
                    <i class="fa-solid fa-blog"></i> Quản Lí Blog
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/admin-contacts" class="${fn:contains(uri, 'admin-contacts') ? 'active' : ''}">
