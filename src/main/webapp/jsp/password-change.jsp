            ...
            <div class="account-container">
                <aside class="account-sidebar">
                    <ul>
                        ...
                        <li>
                            <a href="Password_change.html" class="active">
    ...
    <footer class="main-footer">
        <div class="footer-container">
            <div class="footer-col footer-col-info">
                <div class="footer-logo"><img src="images/logo.webp" height="80" width="80" /></div>
                <p class="footer-description">Đối tác tin cậy cho máy in và văn phòng phẩm từ năm 2010.</p>
            </div>
            ...
            <div class="footer-col">
                <h4 class="footer-heading">Theo Dõi</h4>
