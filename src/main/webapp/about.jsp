...
<body>
    ...
    <div class="main">
        <div class="about-hero-section">
            <img src="images/contact-bg.webp" alt="Đội ngũ PaperCraft đang làm việc" class="about-hero-bg"
        ...
        <div class="about-mission-section">
            <div class="content-container">
                ...
                <p class="section-subtitle">
                    ...
                    thể
                    tập trung vào điều quan trọng nhất: PHÁT TRỂN KINH DOANH.
                </p>
            </div>
        </div>
        ...
        <div class="stats-section">
            <div class="stats-grid">
                ...
                <div class="stat-item">
                    <h3 class="stat-number" data-goal="50000">0+</h3>
                    <p class="stat-text">Khách Hàng Hài Lòng</p>
                </div>
                <div class="stat-item">
                    <h3 class="stat-number" data-goal="100000">0+</h3>
                    <p class="stat-text">Sản Phẩm Đã Bán</p>
                </div>
                <div class="stat-item">
                    <h3 class="stat-number" data-goal="25">0+</h3>
